const SKELETON_ITEMS = ['rv1', 'rv2', 'rv3', 'rv4', 'rv5', 'rv6', 'rv7', 'rv8'] as const;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16">
        {/* Page Title Skeleton */}
        <div className="mb-8">
          <div className="h-10 w-56 bg-gradient-to-r from-blue-200 to-purple-200 rounded-lg animate-pulse" />
        </div>
            ...
            >
              ...
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="h-6 w-16 bg-gradient-to-r from-blue-100 to-purple-100 rounded-full animate-pulse" />
                </div>
              </div>
            </div>
          ))}
